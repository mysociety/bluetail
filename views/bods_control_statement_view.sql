...
SELECT
        ...
        b.statement_json -> 'interests' -> 0 ->> 'beneficialOwnershipOrControl' AS beneficial_ownership_or_ontrol,
        ...
        b.statement_json -> 'interestedParty' ->> 'describedByPersonStatement' AS interested_person_statement,
        b.statement_json -> 'interestedParty' ->> 'describedByEntityStatement' AS interested_person_statement,
